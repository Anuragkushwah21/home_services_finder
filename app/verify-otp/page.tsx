  ...
  const handleVerifyOTP = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (!verifyUserResponse.ok) {
        const verifyData = await verifyUserResponse.json();
          ...
          <div className="card">
            ...
            {!success ? (
              <form onSubmit={handleVerifyOTP} className="space-y-4">
                ...
                <div>
                  <label className="block font-bold text-sm mb-2">Enter Code *</label>
                  <input
                    type="text"
                    value={otp}
                ...
                <Link href="/signup" className="block text-center text-sm text-primary font-bold hover:underline">
                  Back to Sign Up
                </Link>
              </form>
            ) : (
