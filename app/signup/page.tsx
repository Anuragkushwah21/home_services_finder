...
export default function SignupPage() {
  ...
  const handleSendOTP = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (!formData.confirmPassword) throw new Error('Confirm password is required');
      ...
      const checkResponse = await fetch('/api/users?email=' + encodeURIComponent(formData.email));
          ...
          <div className="card">
            ...
            {step === 'form' && (
              <form onSubmit={handleSendOTP} className="space-y-4">
                ...
                <div>
                  <label className="block font-bold text-sm mb-2">Account Type *</label>
                  <select
                    name="role"
                    value={formData.role}
                    onChange={handleChange}
                  ...
                  >
                    ...
                    <option value="vendor">Service Provider (Offer Services)</option>
                  </select>
                </div>
